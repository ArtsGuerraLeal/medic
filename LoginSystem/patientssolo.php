      ...
      <div id="wrapper">
       ...
       if(isset($_SESSION['userId'])){
         ...
         <div class="nav tab">
           ...
           <button class="tablinks nav-item my-3 mx-1 btn btn-primary" onclick="openTab(event,'. "'Tab4'" .')">Picture</button>
           <button class="tablinks nav-item my-3 mx-1 btn btn-primary" onclick="openTab(event,'. "'Tab3'" .')">Other</button>
         </div>
         </div>

          <div class="card-body ">
            <form action="includes/patient-input.inc.php" method="post" enctype="multipart/form-data">
              ...
              <input type="file" name="upload_image" id="upload_image" accept="image/*" onchange="readURL(this);"/>
                     <br />
